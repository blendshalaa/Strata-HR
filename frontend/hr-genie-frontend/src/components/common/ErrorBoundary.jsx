    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-[60vh] flex flex-col items-center justify-center p-6 text-center animate-fadeIn">
          <div className="w-16 h-16 bg-red-50 border border-red-200 text-red-600 rounded-2xl flex items-center justify-center mb-6 shadow-sm">
          ...
          <div className="flex items-center gap-3">
            <button 
              ...
              className="px-5 py-2.5 bg-zinc-900 text-white rounded-md font-bold text-[13px] hover:bg-zinc-800 transition-colors flex items-center gap-2"
            >
