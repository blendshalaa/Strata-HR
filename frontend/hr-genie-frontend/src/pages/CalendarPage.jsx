                            ...
                            >
                                ...
                                <div className="flex items-center justify-between mb-1.5">
                                    <span className={`
                                        ...
                                        ${isTodayCell
                                            ? 'bg-[#111318] text-white w-7 h-7 rounded-full flex items-center justify-center'
                ...
                <div className="modal-overlay" onClick={() => setSelectedEvent(null)}>
                    <div className="bg-white border border-zinc-200 rounded-md max-w-md w-full shadow-xl animate-fadeIn" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="p-5 space-y-4">
                            <div className="flex items-center gap-3">
                                <div className="bg-[#111318] p-2.5 rounded-md flex flex-col items-center justify-center min-w-[3.5rem] text-white">
