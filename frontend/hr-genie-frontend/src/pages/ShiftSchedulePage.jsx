...
const SHIFT_TYPES = [
    ...
    { value: 'afternoon', label: 'Afternoon', color: 'bg-[#EEF0FF] text-[#5B4FE8] border-blue-200' },
                ...
                <div className="flex items-center justify-between px-5 py-3 border-b border-zinc-200">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        {canManage && weekOffset === 0 && (
                            ...
                            >
                                {copyLoading
                                    ? <div className="w-3 h-3 border border-zinc-400 border-t-[#5B4FE8] rounded-full animate-spin" />
                    ...
                    <div className="bg-white border border-zinc-200 rounded-md max-w-md w-full shadow-xl animate-fadeIn" onClick={e => e.stopPropagation()}>
                        ...
                        <form onSubmit={handleCreate} className="p-5 space-y-4">
                            ...
                            <div className="flex justify-end gap-3 pt-2">
                                ...
                                <button type="submit" disabled={createLoading} className="px-5 py-2 bg-[#5B4FE8] text-white text-[12px] font-bold uppercase tracking-wider rounded-md hover:bg-[#4a3fd4] transition-colors">
