  ...
  return (
    <div className="h-full flex flex-col bg-white border-r border-zinc-200">
      <div className="p-5 border-b border-zinc-100">
        <button
          onClick={onNew}
          className="w-full flex items-center justify-center gap-2 bg-[#111318] text-white px-4 py-2 text-[12px] font-bold uppercase tracking-wider rounded-md hover:bg-[#374151] transition-colors"
        >
          ...
          conversations.map((conv) => (
            ...
            >
              <div className="flex items-start gap-3">
                <div className={`p-1.5 rounded-md ${activeConversation === conv.id ? 'bg-[#111318] text-white' : 'bg-zinc-100 text-zinc-400'}`}>
