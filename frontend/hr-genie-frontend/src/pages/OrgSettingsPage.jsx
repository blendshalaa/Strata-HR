                    ...
                    <div className="flex-1">
                        {editing ? (
                            <div className="flex items-center gap-2">
                                ...
                                />
                                <button onClick={handleUpdateName} className="bg-zinc-900 hover:bg-zinc-800 text-white px-4 py-2 rounded-md font-bold text-sm transition-colors">Save</button>
