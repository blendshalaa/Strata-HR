...
const PayslipModal = ({ isOpen, onClose, payroll }) => {
    ...
    return (
        <div className="fixed inset-0 bg-zinc-900/40 z-50 flex items-center justify-center p-4 animate-fadeIn print:bg-white print:static print:p-0">
            <div className="bg-white border border-zinc-200 rounded-lg shadow-lg w-full max-w-lg overflow-hidden animate-slideUp print:shadow-none print:border-none print:w-full print:max-w-none">
                ...
                <div className="p-8 print:p-0">
                    ...
                    <div className="flex justify-end">
                        <div className="bg-zinc-900 rounded-md p-5 w-64 text-white">
